...
def calculate_similarity():
    ...
    # Read the intermediate files to dictionaries.
    user_rated_movies = csv.DictReader(open('q2_user_rated_movies.txt', 'r'), delimiter='\t')
    user_pairs_same_rate = csv.DictReader(
        open('q2_user_pairs_same_rate.txt', 'r'), delimiter='\t')
    user_pairs_same_movie = csv.DictReader(
        open('q2_user_pairs_same_movie.txt', 'r'), delimiter='\t')
    
    #TODO:  Loop the user list, then calculate the similarity scores for all possible pairs.
