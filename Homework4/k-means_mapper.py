...
# One line one centroid. Each centroid is constructed by 25 dimension vector.
...
# Design: each line is a 25 dimension vector, use comma to split items.
...
partial_sums_counts = {}
for i in range(10):
    partial_sums_counts.setdefault(i, [np.zeros((1, 25), dtype=float), 0])
